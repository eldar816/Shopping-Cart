...
const products = [
    ...
    { id: 1, pname: "Golf Casual Shirt", price: 100, sizes: "S/M/L", description: "test2", stars: 3, in_cart: false, in_favorites: false, amount: 0 },
    { id: 2, pname: "Elegant Daily Dress", price: 150, sizes: "S/M", description: "test3", stars: 5, in_cart: false, in_favorites: false, amount: 0 },
    { id: 3, pname: "Classic Unique Dress", price: 70, sizes: "XL/XXL", description: "test1", stars: 4, in_cart: false, in_favorites: false, amount: 0 },
    { id: 4, pname: "Gym One Color Sport Outfit", price: 120, sizes: "S/M/XL/XXL", description: "test2", stars: 3, in_cart: false, in_favorites: false, amount: 0 },
    ...
    { id: 6, pname: "Men's Elegant Blazer", price: 150, sizes: "S/M/L", description: "test1",type: 'men' ,stars: 4, in_cart: false, in_favorites: false, amount: 0 },
    { id: 7, pname: "Men's Casual Daily Blazer", price: 100, sizes: "L/XL/XXL", description: "test2", type: 'men',stars: 3, in_cart: false, in_favorites: false, amount: 0 },
    ...
    { id: 9, pname: "Men's Classic Jeans", price: 70, sizes: "S/M/L/XL/XXL", description: "test1", type: 'men',stars: 4, in_cart: false, in_favorites: false, amount: 0 },
    { id: 10, pname: "Classic Tunique Daily Style", price: 140, sizes: "L/XL/XXL", description: "test2", type: 'men',stars: 3, in_cart: false, in_favorites: false, amount: 0 },
...
function updatePage() {
    ...
    for (let i = 0; i < products.length; i++) {
        ...
        _res.innerHTML += `<div class="col-md-4">
        <div class="card mb-4 product-wap rounded-0">
        <div class="card rounded-0" onclick="singlePage${i}">
        <img class="card-img rounded-0 img-fluid" src="assets/img/shop_${products[i].id}.jpg" >
        <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
        <ul class="list-unstyled">
        ${FavoritesCheck}
        ...
        <div class="card-body">
        <div class="__link"><p class="h3 text-decoration-none" onclick="singlePage(${i})">${products[i].pname}</p></div>
        <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
...
function updateFavorites() {
    ...
    for (let i = 0; i < favorites.length; i++) {
        ...
        <div class="card mb-4 product-wap rounded-0">
            ...
            <div class="card-body" onclick="singlePage(${i})">
                <div class="__link"><p class="h3 text-decoration-none">${products[i].pname}</p></div>
                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
